...
class MongoBulkWriteStream extends Writable {
  constructor (opts) {
    ...
    this._bulkHasOperations = (b) => b && b.s && b.s.currentBatch && b.s.currentBatch.operations && b.s.currentBatch.operations.length > 0;    
  }
  ...
  _write (chunk, enc, next) {
    ...
    this._cb(this._bulk, chunk, (e) => {
      if (e && e instanceof Error) {
        ...
        this.counter++;
        if (this.counter === opts.highWaterMark && this._bulkHasOperations(this._bulk)) {
          this.counter = 0;
  ...
  _flush (next) {
    if (!this._isEmpty && this._bulkHasOperations(this._bulk)) {
      try {
